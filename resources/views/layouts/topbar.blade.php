                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link " href="javascript:void(0);" data-bs-toggle="dropdown">
									...
									<span class="badge light text-white bg-primary rounded-circle">23</span>
                                </a>
								<div class="dropdown-menu dropdown-menu-end">
							...
							<li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
									...
									<div class="header-info ms-3">
										...
										<small class="fs-12 font-w400">{{ Auth::user()?->email ?? 'demo@gmail.com' }}</small>
									</div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a href="{{ route('dashboard') }}" class="dropdown-item ai-icon">
                                        <svg id="icon-dashboard" xmlns="http://www.w3.org/2000/svg" class="text-info" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="9"></rect><rect x="14" y="3" width="7" height="5"></rect><rect x="14" y="12" width="7" height="9"></rect><rect x="3" y="16" width="7" height="5"></rect></svg>
                                    ...
                                    {{-- <form method="POST" action="{{ route('logout') }}" class="dropdown-item ai-icon" style="cursor: pointer;" onclick="event.preventDefault(); this.submit();">
                                        @csrf
                                        <svg id="icon-logout" xmlns="http://www.w3.org/2000/svg" class="text-danger" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
                                        <span class="ms-2">Logout </span>
                                    </form> --}}
